...
const howItWorksContent = {
  heading: {
    ...
    description:
      "iMovn chuyên trong lãnh vực lập trình & thiết kế website, app mobile cùng các dịch vụ markekting online đa kênh. Với hơn 9 kinh nghiệm, chúng tối cam kết mang đến Quý khách hàng các giải pháp sáng tạo & hiệu quả nhất để thúc đẩy doanh nghiệp của bạn!",
  },
  ...
  workStep: [
    {
      ...
      description:
        "Cấu trúc website chuẩn SEO theo checklist Google, sáng tạo, công nghệ thiết kế & lập trình web hiện đại như Nextjs - Reactjs - Nodejs - Firebase - Wordpress.",
      btn: {
  ...
  smallServices: [
...

    {
      ...
      title: "Content SEO",
      description:
        "iMovn nghiên cứu đối thủ cạnh tranh cùng bạn để tìm ra các chủ đề đang triển khai và kết hợp nghiên cứu từ khóa để phân nhóm chủ đề mới. Triển khai content đa dạng, độc nhất và chuẩn SEO khi đăng lên website của bạn.",
      btn: {
        ref: "/",
        label: "Xem chi tiết",
      },
...

    {
      ...
      description:
        "Dịch vụ đi backlink entity của chúng tôi tập trung vào việc xây dụng các liên kết ngược chất lượng cao về web của bạn. Giúp tăng cường thứ hạng, độ uy tín & độ tin cậy với công cụ tìm kiếm & tiếp cận khách tiềm năng",
      btn: {
        ref: "/",
        label: "Xem chi tiết",
      },
            ...
            {howItWorksContent.workStep.map((step, index) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{
                    y: -10,
                    transition: { duration: 0.1 }, // Cập nhật kiểu dữ liệu của transition
                  }}
                  key={step.title}
                  className="group duration-300 pt-32 pl-5 pr-5 pb-10 bg-white relative overflow-hidden hover:bg-secondary hover:text-white"
                >
                  ...
                  <div className="relative flex gap-3 items-start mt-5">
                    <div>
                      ...
                      <p>
                        <Link
                          href={step.btn.href}
                          className="text-[14px] tracking-[2px] uppercase border-b-2 pb-2 inline-block border-[#FF7431] duration-300 transition-all ease-in-out group-hover:font-extrabold group-hover:text-[#FF7431] group-hover:border-white"
                        >
                          {step.btn.label}
                        </Link>
                      </p>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p>
                        <Link
                          href={smStep.btn.ref}
                          className="text-[14px] text-[#FF7431] tracking-[2px] uppercase border-b-2 pb-2 inline-block border-white border-opacity-25 duration-300 transition-all ease-in-out hover:font-extrabold hover:text-[#FF7431] hover:border-white"
                        >
                          {smStep.btn.label}
                        </Link>
                      </p>
