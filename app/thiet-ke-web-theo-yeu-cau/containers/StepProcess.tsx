...
const headingSection = {
    heading: {
        ...
        description: "Thiết kế website là giải pháp hiệu quả với mỗi doanh nghiệp hiện nay nhưng trước khi có được một trang web chuyên nghiệp và hoàn hảo cần sự phối hợp giữa đơn vị thiết kế theo một quy trình thống nhất. Dựa trên những kinh nghiệm thiết kế website chuẩn Seo cho nhiều dự án lớn nhỏ khác nhau. Đội ngũ kỹ thuật iMovn đã ra quy trình thiết kế web với 9 bước cơ bản sau..."
    },
}

const StepProcess = () => {
    const steps = [
        { step: 1, title: "Khảo sát yêu cầu", desc: "Chúng tôi lắng nghe và hiểu rõ nhu cầu của bạn, đảm bảo mọi thứ được định hướng đúng." },
        { step: 2, title: "Phác thảo ý tưởng", desc: "Đưa ra các bản phác thảo, định hình giao diện và trải nghiệm người dùng." },
        { step: 3, title: "Thiết kế giao diện", desc: "Thiết kế đồ họa trực quan, tối ưu hóa trải nghiệm người dùng." },
        { step: 4, title: "Lập trình chức năng", desc: "Xây dựng hệ thống chức năng theo yêu cầu và đảm bảo tính bảo mật." },
        { step: 5, title: "Kiểm tra & tinh chỉnh", desc: "Chạy thử nghiệm trên nhiều thiết bị, tối ưu hóa tốc độ và trải nghiệm." },
        { step: 6, title: "Bàn giao & hướng dẫn", desc: "Bàn giao website hoàn chỉnh và hướng dẫn sử dụng cho bạn." },
        { step: 7, title: "Hỗ trợ sau bán hàng", desc: "Luôn đồng hành cùng bạn, hỗ trợ nhanh chóng và kịp thời." },
        { step: 8, title: "Đánh giá hiệu suất", desc: "Theo dõi và phân tích hiệu suất website sau khi ra mắt để cải thiện." },
        { step: 9, title: "Nâng cấp và phát triển", desc: "Duy trì và nâng cấp website theo nhu cầu và xu hướng mới." },
    ];
                ...
                {steps.map((step, index) => (
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            <h3 className="text-xl font-extrabold mb-2 text-primary capitalize">{step.title}</h3>
